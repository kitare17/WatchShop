  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <p>
        <strong>
                    <span style="font-size: 18px">
                        Chúng tôi luôn biết, việc VapeShop có thể vững mạnh hay không phụ thuộc rất nhiều vào tình yêu,
      ...
      <p>
        <strong>
                    <span style="font-size: 18px">
                        Chính vì thế, VapeShop tự tin khi luôn cải thiện chất lượng dịch vụ,
                        hàng hoá sản phẩm để luôn là chỗ đứng chắc chắn trong lòng của bất kì tín đồ Vape, Pod nào.
                    </span>
        </strong>
      </p>
      <p style="text-align: center; margin-top: 30px">
